...
module.exports.prototype.pop = function () {
  ...
  var secondLast = this._entry.prev.prev
  secondLast.next = this._entry
  this._entry.prev = secondLast
...
module.exports.prototype.forEach = function (cb) {
  if(typeof(cb) !== 'function' || this._length === 0) { return }
...
module.exports.prototype.include = function (query) {
  var c = this._current
  var result = this.find(function (item) { return item === query })
  this._current = c
  if(result !== false) {
    return true
  }
